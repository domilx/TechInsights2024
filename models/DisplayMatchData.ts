...
const displayMatchData = (match: MatchModel) => {
    const data = [
        ...
        // Auto Objectives
        { label: "Auto Objective 1", value: match.AutoObjective1 ? "Yes" : "No" },
        { label: "Auto Objective 2", value: match.AutoObjective2 ? "Yes" : "No" },
        { label: "Auto Objective 3", value: match.AutoObjective3 ? "Yes" : "No" },
        { label: "Auto Objective 4", value: match.AutoObjective4 ? "Yes" : "No" },
        { label: "Auto Robot Falls", value: match.AutoRobotFalls ? "Yes" : "No" },
        // Teleop Phase Details
        { label: "Cycle Time", value: match.CycleTime.toString() },
        // Endgame Objectives
        { label: "End Game Objective 1", value: match.EndGameObjective1 ? "Yes" : "No" },
